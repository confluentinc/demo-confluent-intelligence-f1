...
-- fills normally, and every row carries `anomaly_tire_temp_fl = false`. The lap-24
...
--    per-lap sampling stays consistent and the gate clears well before the lap-24
--    anomaly — measured at the old size 20, `forecast_value` started populating at
--    about row 21; at 12 it clears around row 13 (roughly 4-5 minutes at 20s/lap).
...
--    On the ARIMA version this is what suppresses the post-pit drop after lap 24
